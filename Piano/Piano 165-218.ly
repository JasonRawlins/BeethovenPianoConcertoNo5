...
right_OneHundredSixtyFive_TwoHundredEighteen = \relative c' {  
    % 165
  ...
  % 199
  \change Staff = "left" \stemUp bes16 g e des r4 r4 \tuplet 5/4 { ges16 \( a \change Staff = "right" c! ees! ges \) } |
  % 200
  \stemUp r4 \change Staff = "left" f,16 bes \change Staff = "right" d f r4 \change Staff = "left" f,16 a \change Staff = "right" ees' f |
  % 201
  r4 \change Staff = "left" f,16 bes \change Staff = "right" d f r4 \change Staff = "left" g,16 bes \change Staff = "right" ees g \stemNeutral |
  % 202
  \change Staff = "left" \stemUp f,8 f g a bes-. f-. c'-. f-. |
  % 203
  \change Staff = "right" d8 \change Staff = "left" f, \change Staff = "right" ees' \change Staff = "left" f, \change Staff = "right" f' \change Staff = "left" f, \change Staff = "right" g' \change Staff = "left" g, |
  % 204
  \change Staff = "right" a'8 a, bes' bes, c' c, d' d, |
  % 205
  ees'8 ees, f' f, g' g, a' a, |
  % 206
  \stemNeutral bes'16 bes, c' c, d' d, ees' ees, \ottava 1 f' f, g' g, a' a, bes' bes, |
  % 207
  c' c, d' d, ees' ees, e' e, f' f, f' f, d' d, bes' bes, |
  % 208
  r16 ees'! d c bes a g f \ottava 0 ees d c bes a g f ees |
  % 209
  \ottava 1 r16 c'' bes a g f ees d \ottava 0 c bes a g f ees d c |
  % 210
  r16 a'' g f ees d c bes a g f ees d c bes a |
  % 211
  g16 f ees d \change Staff = "left" \stemUp \voiceOne c bes a g f ees d c bes a g f |
  % 212
  ges ges' a c \change Staff = "right" ees a, c ees ges c, ees g a ees g a |
  % 213
  c16 ges a c ees a, c ees ges c, ees ges a ees ges a |
  % 214
  r16 c,, ees ges a ees ges a c ges a c ees a, c ees |
  % 215
  ges16 c, ees ges a ees ges a c ges a c ees a, c ees |
  % 216
  a,,16 bes! b c cis d ees e f fis g gis a bes! b c |
  % 217  
  \ottava 1
  cis d ees e f fis g gis a bes b c \tuplet 5/4 { cis \( d ees e f \) } |
  % 218
  bes,4 \ottava 0 r4 r2 |
}
...
left_OneHundredSixtyFive_TwoHundredEighteen = \relative c {
  ...
  r1 |
  % 167
  \tuplet 3/2 { ees8 c' a } \tuplet 3/2 { ees8 c a } ees4 r4 |
  % 168
  r1
  % 169
  \tuplet 3/2 { d8 bes' f } \tuplet 3/2 { d' bes f } d4 r4 |
  % 170
  r1
  % 171
  \clef treble
  ...
  % 172
  <c ees>16 f <c ees>16 f <c ees>16 f <c ees>16 f \clef bass f,16 f' e, e' ees, ees' d, d' |
  % 173
  c,16 c' bes, bes' a, a' g, g' f, f' e, e' ees, ees' d, d' |
  % 174
  \stemDown c,16 c' bes, bes' a, a' g, g' f, f' ees ees' d, d' c, c' \stemNeutral |
  % 175
  \tuplet 3/2 { <bes, bes'>8-. bes''-. a-. } \tuplet 3/2 { aes8-. g-. ges-. } \tuplet 3/2 { f8-. e-. ees-. } \tuplet 3/2 { d-. des-. c-. } |
  % 176
  \tuplet 3/2 { bes-. bes'-. a-. } \tuplet 3/2 { aes-. g-. ges-. } \tuplet 3/2 { f-. e-. ees-. } \tuplet 3/2 { d-. des-. c-. } |
  % 177
  \tuplet 3/2 { bes bes' a } \tuplet 3/2 { aes g ges } \tuplet 3/2 { f e ees } \tuplet 3/2 { d cis c } |           
  % 178
  bes16 d f bes bes,16 d f bes c, ees aes c d, f bes d |
  % 179
  \tuplet 3/2 { c,8-. ees'-. d-. } \tuplet 3/2 { des-. c-. ces-. } \tuplet 3/2 { bes-. a-. aes-. } \tuplet 3/2 { g-. ges-. f-. } |
  % 180
  \tuplet 3/2 { ees8 ees' d } \tuplet 3/2 { des c ces } \tuplet 3/2 { bes a aes } \tuplet 3/2 { g ges f } |  
  % 181
  \tuplet 3/2 { ees d des } \tuplet 3/2 { c ces bes } \tuplet 3/2 { a aes g } \tuplet 3/2 { fis f e } |
  % 182
  ees!16 g bes ees g, bes ees g bes, ees g bes ees, g bes ees |
  % 183
  \tuplet 3/2 { c,8 c' b } \tuplet 3/2 { bes a aes } \tuplet 3/2 { g fis f } \tuplet 3/2 { e ees d }
  % 184
  \tuplet 3/2 { c c' b } \tuplet 3/2 { bes a aes } \tuplet 3/2 { g f ees! } \tuplet 3/2 { d c bes! }
  % 185
  ...
  des16 f bes, des bes des f, bes f bes des, f des f bes, des |
  % 194
  \stemDown fes16 <bes des> fes' <bes, des> fes'16 <bes, des> fes' <bes, des> bes,! <bes' des> fes' <bes, des> fes' <bes, des> fes' <bes, des> \stemNeutral |
  % 195
  ...
  % 202
  \stemDown f,,8-. f-. g-. a-. bes-. f-. c'-. f,-. |
  % 203
  d'8 f, ees' f, f' f, g g' \stemNeutral |
  % 204
  ...
  % 212
  \stemDown f16 ges' a c \stemNeutral ees a, c ees ges c, ees ges a ees ges a |
  % 213
